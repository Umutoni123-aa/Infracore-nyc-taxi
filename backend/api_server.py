...
# ── Helper: build WHERE clause from common filter params ────────────────────
def build_filter_clause(borough=None, time_of_day=None, day=None):
"""
Returns (where_clause_string, params_list).
Always starts with 'WHERE 1=1' so callers can safely append more ANDs.
"""
clause = ' WHERE 1=1'
params = []
if borough:
...
# --------------------------------------------------
# TRIPS WITH FILTERS (borough + time_of_day + day)
# --------------------------------------------------
@app.route('/api/trips')
def get_trips():
try:
...
# --------------------------------------------------
# TRIPS BY BOROUGH (FIX: now accepts time_of_day + day filters)
# --------------------------------------------------
...
# --------------------------------------------------
# TRIPS BY HOUR (FIX: now accepts time_of_day + day filters)
# --------------------------------------------------
...
# --------------------------------------------------
# TRIPS BY DAY (FIX: now accepts borough + time_of_day filters)
# --------------------------------------------------
...
# --------------------------------------------------
# TOP ROUTES (FIX: now accepts all three filters)
# --------------------------------------------------
